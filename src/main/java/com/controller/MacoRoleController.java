...
public class MacoRoleController {
	...
	public String getOne(String id) {
		...
		try {
			QaRole macoRole = macoRoleService.getOne(id);
	...
	public String saveMacoRole(QaRole macoRole) {
		JSONObject js = new JSONObject();
		try {
	...
	public String delete(String id) {
		...
		try {
			//查询角色
			QaRole role = macoRoleService.getOne(id);
			//禁止删除管理员和VIP角色
	...
	public String update(QaRole newMacoRole) {
		JSONObject js = new JSONObject();
